...
def create_prompt(title):
    prompt = """Veechente's Quick Healthy Food Recipes Website
 
    Biography
    I am a python developer learning how to create food blogs!
    
    Blog

    Jan 31, 2023
    Title: "Easy healthy meal prep ideas"
    tags: healthy, food, meal prep
    Summary: I rey to generate healthy meal ideas that are quick and easy to prepare.
